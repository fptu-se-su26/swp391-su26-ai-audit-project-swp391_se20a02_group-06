...
-- Uses existing roles (1-3) and users (1-3)
-- from the v2 schema seed data.
--   id=1  Nguyen Van Admin  (ADMIN)
--   id=2  Huan Luyen Vien   (PT)
--   id=3  Hoi Vien          (MEMBER)
-- ==========================================
...
-- ==========================================
INSERT IGNORE INTO pt_profiles (user_id, bio, specialization, experience_years, rating, hourly_rate) VALUES
(2, 'Certified strength and conditioning coach with 7 years of hands-on experience helping members reach their physique and performance goals.',
 'Strength & Conditioning', 7, 4.90, 350000.00);
...
-- ==========================================
INSERT IGNORE INTO exercises (id, title, description, video_url, thumbnail_url, muscle_group_id, difficulty, equipment, duration_minutes, calories_burn_per_min, created_by, status) VALUES
(1,  'Barbell Bench Press',    'Classic flat-bench chest compound movement with a barbell.',                                'https://example.com/videos/bench-press',     NULL, 1, 'INTERMEDIATE', 'Barbell, Bench',      45, 8.00,  2, 'APPROVED'),
(2,  'Pull-Up',                'Upper-body pulling exercise targeting lats and biceps.',                                    'https://example.com/videos/pull-up',         NULL, 2, 'INTERMEDIATE', 'Pull-Up Bar',         30, 7.50,  2, 'APPROVED'),
(3,  'Barbell Back Squat',     'King of leg exercises — full lower-body compound movement.',                                'https://example.com/videos/back-squat',      NULL, 3, 'ADVANCED',     'Barbell, Rack',       60, 9.00,  2, 'APPROVED'),
(4,  'Overhead Press',         'Press a barbell overhead to build shoulder strength and stability.',                        'https://example.com/videos/ohp',             NULL, 4, 'INTERMEDIATE', 'Barbell',             40, 7.00,  2, 'APPROVED'),
(5,  'Dumbbell Bicep Curl',    'Isolation exercise for building bicep peak and size.',                                      'https://example.com/videos/bicep-curl',      NULL, 5, 'BEGINNER',     'Dumbbells',           20, 5.00,  2, 'APPROVED'),
(6,  'Plank',                  'Isometric core hold building stability and endurance.',                                     'https://example.com/videos/plank',           NULL, 6, 'BEGINNER',     'No Equipment',        15, 4.00,  2, 'APPROVED'),
(7,  'Deadlift',               'Full-body posterior-chain compound lift.',                                                  'https://example.com/videos/deadlift',        NULL, 2, 'ADVANCED',     'Barbell',             50, 9.50,  2, 'APPROVED'),
(8,  'HIIT Treadmill Sprint',  '30-second all-out sprints alternated with 30-second rest intervals.',                      'https://example.com/videos/hiit-treadmill',  NULL, 7, 'INTERMEDIATE', 'Treadmill',           20, 12.00, 2, 'APPROVED'),
(9,  'Dumbbell Lunges',        'Unilateral leg exercise improving balance and quad strength.',                              'https://example.com/videos/lunges',          NULL, 3, 'BEGINNER',     'Dumbbells',           25, 6.50,  2, 'APPROVED'),
(10, 'Cable Tricep Pushdown',  'Isolation movement for tricep mass and definition.',                                        'https://example.com/videos/tricep-pushdown', NULL, 5, 'BEGINNER',     'Cable Machine',       20, 5.00,  2, 'APPROVED'),
(11, 'Romanian Deadlift',      'Hip-hinge movement targeting hamstrings and glutes.',                                       'https://example.com/videos/rdl',             NULL, 3, 'INTERMEDIATE', 'Barbell / Dumbbells', 35, 7.00,  2, 'APPROVED'),
(12, 'Battle Ropes',           'High-intensity conditioning exercise using heavy ropes.',                                   'https://example.com/videos/battle-ropes',    NULL, 7, 'INTERMEDIATE', 'Battle Ropes',        15, 13.00, 2, 'APPROVED'),
(13, 'Incline Dumbbell Press', 'Targets the upper chest on a 30–45-degree incline bench.',                                 'https://example.com/videos/incline-press',   NULL, 1, 'INTERMEDIATE', 'Dumbbells, Bench',    35, 7.50,  2, 'PENDING'),
(14, 'Hanging Leg Raise',      'Core exercise: hang from a bar and raise legs to 90 degrees.',                             'https://example.com/videos/leg-raise',       NULL, 6, 'INTERMEDIATE', 'Pull-Up Bar',         20, 5.50,  2, 'APPROVED'),
(15, 'Yoga Sun Salutation',    'Flowing 12-pose sequence to warm up and mobilize the entire body.',                        'https://example.com/videos/sun-salutation',  NULL, 7, 'BEGINNER',     'Yoga Mat',            20, 4.50,  1, 'APPROVED');
...
(1,  'Grilled Chicken Breast',  '100', 'g',     165, 31.00, 0.00,  3.60,  NULL),
(2,  'White Rice (cooked)',     '100', 'g',     130, 2.70,  28.00, 0.30,  NULL),
(3,  'Whole Eggs',              '1',   'piece',  78, 6.00,  0.60,  5.30,  NULL),
(4,  'Oatmeal (dry)',           '100', 'g',     389, 17.00, 66.00, 7.00,  NULL),
(5,  'Steamed Broccoli',        '100', 'g',      55, 3.70,  11.00, 0.60,  NULL),
(6,  'Baked Salmon',            '100', 'g',     208, 20.00, 0.00,  13.00, NULL),
(7,  'Boiled Sweet Potato',     '100', 'g',      86, 1.60,  20.00, 0.10,  NULL),
(8,  'Whey Protein Shake',      '1',   'scoop', 120, 24.00, 3.00,  1.50,  NULL),
(9,  'Greek Yogurt (plain)',    '100', 'g',      59, 10.00, 3.60,  0.40,  NULL),
(10, 'Banana',                  '1',   'piece', 105, 1.30,  27.00, 0.30,  NULL),
(11, 'Avocado',                 '100', 'g',     160, 2.00,  9.00,  15.00, NULL),
(12, 'Brown Rice (cooked)',     '100', 'g',     112, 2.60,  23.50, 0.90,  NULL),
(13, 'Almonds',                 '30',  'g',     174, 6.00,  6.00,  15.00, NULL),
(14, 'Tuna (canned in water)',  '100', 'g',     116, 26.00, 0.00,  1.00,  NULL),
(15, 'Low-fat Cottage Cheese',  '100', 'g',      98, 11.00, 3.40,  4.30,  NULL),
(16, 'Raw Spinach',             '100', 'g',      23, 2.90,  3.60,  0.40,  NULL),
(17, 'Whole Wheat Bread',       '1',   'slice',  69, 3.60,  12.00, 1.10,  NULL),
(18, 'Peanut Butter',           '2',   'tbsp',  188, 8.00,  6.00,  16.00, NULL),
(19, 'Orange',                  '1',   'piece',  62, 1.20,  15.40, 0.20,  NULL),
(20, 'Whole Milk',              '250', 'ml',    149, 8.00,  12.00, 8.00,  NULL);
...
(2, 3, 'NUTRITION_DIET',
 ...
 '{"diet_title":"High-Protein Fat Loss Plan","daily_calories":1900,"protein_target_g":175,"meals":[{"name":"Breakfast","foods":["Oatmeal","Whole Eggs","Banana"],"calories":500},{"name":"Lunch","foods":["Grilled Chicken Breast","Brown Rice","Steamed Broccoli"],"calories":580},{"name":"Post-Workout Snack","foods":["Whey Protein Shake","Banana"],"calories":225},{"name":"Dinner","foods":["Baked Salmon","Boiled Sweet Potato","Raw Spinach"],"calories":420},{"name":"Evening Snack","foods":["Greek Yogurt","Almonds"],"calories":175}]}',
 'deepseek-chat', '2025-03-11 09:00:00'),
(3, 3, 'WORKOUT_PLAN',
...
(1, 3, 2, 'Breakfast',         '07:00:00', 500, '2025-03-11 09:05:00'),
(2, 3, 2, 'Lunch',             '12:00:00', 580, '2025-03-11 09:05:00'),
(3, 3, 2, 'Post-Workout Snack','16:00:00', 225, '2025-03-11 09:05:00'),
(4, 3, 2, 'Dinner',            '19:00:00', 420, '2025-03-11 09:05:00'),
(5, 3, 2, 'Evening Snack',     '21:00:00', 175, '2025-03-11 09:05:00'),
(6, 3, NULL,'Pre-Workout Meal','07:30:00', 380, '2025-06-02 12:00:00');
...
(1, 4,  '80g',     1),   -- Oatmeal
(1, 3,  '2 pieces',1),   -- Eggs
(1, 10, '1 piece', 1),   -- Banana
-- Lunch
(2, 1,  '150g',    1),   -- Grilled Chicken
(2, 12, '150g',    1),   -- Brown Rice
(2, 5,  '100g',    1),   -- Broccoli
-- Post-Workout Snack
(3, 8,  '1 scoop', 1),   -- Whey Protein
(3, 10, '1 piece', 1),   -- Banana
-- Dinner
(4, 6,  '150g',    0),   -- Salmon
(4, 7,  '150g',    0),   -- Sweet Potato
(4, 16, '80g',     0),   -- Spinach
-- Evening Snack
(5, 9,  '150g',    0),   -- Greek Yogurt
(5, 13, '15g',     0),   -- Almonds
-- Pre-Workout Meal (custom)
(6, 17, '2 slices',0),   -- Whole Wheat Bread
(6, 18, '1 tbsp',  0),   -- Peanut Butter
(6, 20, '250ml',   0);   -- Whole Milk
